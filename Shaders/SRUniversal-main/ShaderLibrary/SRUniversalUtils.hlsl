...
float3 GetMainLightBrightness(float3 inputMainLightColor, float brightnessFactor, float brightnessThresholdMin, float brightnessThresholdMax, float brightnessOffset)
{
...
float3 GetMainLightDiffuse(Light light, float brightnessFactor, float brightnessThresholdMin, float brightnessThresholdMax, float brightnessOffset, float mainLightColorUsage)
{
    ...
    color = GetMainLightBrightness(color, brightnessFactor, brightnessThresholdMin, brightnessThresholdMax, brightnessOffset);
