Shader "HonkaiStarRailToon/Character/Hair"
{
    Properties
    {
        [HideInInspector] [KeywordEnum(None, Face, Hair, UpperBody, LowerBody)] _Area("Material area", Float) = 2
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "SRCharDrawHairFakeTransparent"
